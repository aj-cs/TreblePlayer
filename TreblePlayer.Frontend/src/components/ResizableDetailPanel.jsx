...
const ResizableDetailPanel = ({ album, onResize, onTrackDoubleClick }) => {
  ...
  return (
    ...
    >
      <Box sx={{ position: 'relative', width: `${width}px`, height: '100%' }}>
        <AlbumDetailView album={album} width={width} onTrackDoubleClick={onTrackDoubleClick} />
      </Box>
    </Resizable>
  );
};
